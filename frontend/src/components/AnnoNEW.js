...
class AnnoNEW extends React.Component {
  ...
  sendDatasetToServer = () => {
    ...
    form_data.append(
      "name",
      this.props.location.state.datasetName.dataset_name
    );
    form_data.append(
      "language",
      this.props.location.state.datasetName.language
    );
  ...
  updateAnnotatio = (data) => {
    this.setState({
      files: update(this.state.files, {
        [this.state.index_active_file_in_files]: { boxes: { $set: data } },
      }),
    });
  };
    ...
    return (
      <div style={{ textAlign: "center" }}>
        ...
        <button
          ...
          onClick={this.sendDatasetToServer}
        >
          Save state of annotation
        </button>
        <button className="btn btn-secondary" onClick={this.sendUpdateToServer}>
          Update annotation
        </button>
        <button className="btn btn-secondary" onClick={this.createDataset}>
          Create Dataset
        </button>
        <br />
        {/* Body container  */}
        ...
        <div className="containerone ">
          ...
          <div>
            ...
            >
              <AnnotateOnPic
                updateAnnotatio={this.updateAnnotatio}
